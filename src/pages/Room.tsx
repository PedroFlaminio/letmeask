  ...
  const QuestionList = (
    <div className="question-list">
      {questions.map((question) => {
        return (
          <Question key={question.id} content={question.content} author={question.author} dark={theme==="dark"}>
            <button
  ...
  return (
    <div id="page-room" className={theme}>
      <header>
        <div className="content">
          ...
          <div>
            ...
            <RoomCode dark={theme==="dark"} code={roomId}  />
          </div>
        </div>
      </header>
      ...
      <main>
        ...
        {endedAt === undefined || endedAt === null ? "": Form}
